...
**Nuvarande text:** "Denna kallelse skall innehålla all nödvändig
bakgrundsinformation samt poströstsedlar för alla relevanta ärenden på
dagordningen."

**Föreslagen ny text:**
_Denna kallelse skall innehålla all nödvändig bakgrundsinformation samt länk
och instruktioner för digital röstning för alla relevanta ärenden på
dagordningen._
...
**Föreslagen ny text:**
_Röstlängden utgörs av de fullvärdiga medlemmar som aktivt avger en röst
...
gång. Enbart inloggning i röstningssystemet grundar inte närvaro i röstlängd._
...
**Föreslagen ändring:**
_Samtliga paragrafer som reglerar pappersbaserad poströstning (§ 5.5.12 och
relaterade paragrafer) stryks i sin helhet och ersätts av ett ramverk för
digital förtidsröstning._

**Föreslagen ny text för § 5.5.12 (Förtidsröstning):**
_Förtidsröstning sker exklusivt via ett säkert digitalt röstningssystem.
...
omröstningen för stängd under pågående årsmöte._
...
**Föreslagen ny text:**
_All rösträkning, inklusive uträkning av mandat enligt "Enkel överförbar röst"
...
rättssäkerhet genom funktionstestning, säkerhetsgranskning och vid första
användning pilottest. Testresultat ska rapporteras till styrelsen före mötet.
Ingen data som kopplar en specifik medlems identitet till en specifik röst
får lagras permanent._

### Ny paragraf § 5.7 - Definition av närvaro vid digitala årsmöten

_Vid digitala årsmöten definieras närvaro enligt följande:_

- **_Fysiskt närvarande:_** _Medlem som befinner sig i möteslokalen_
- **_Digitalt närvarande:_** _Medlem som är inloggad i det digitala systemet
  och aktivt följer mötet_
- **_Röstberättigad:_** _Fullvärdig medlem som är fysiskt eller digitalt
  närvarande_
- **_Röstande:_** _Medlem som aktivt avger röst i en specifik fråga (ingår i
  röstlängden för den frågan)_

_Rätt att tala, ställa frågor och lägga rådgivande motioner tillkommer alla
fysiskt och digitalt närvarande medlemmar enligt mötesordförandens
ordningsregler._

### Ny paragraf § 5.8 - Autentisering och medlemsverifiering

_Inloggning i det digitala röstningssystemet ska ske via:_

- _Freja eID+ för medlemmar med svenskt personnummer. Systemet verifierar
  automatiskt medlemskap genom att matcha personnummer mot medlemsregistret
  (Föreningshuset)._
- _För utländska medlemmar utan svenskt personnummer krävs manuellt
  godkännande av valkommittén innan röstning tillåts. Valkommittén verifierar
  medlemskap mot medlemsregistret och godkänner medlemmen för röstning i
  systemet._
- _Valkommittén ansvarar för att säkerställa att autentiseringsmetoderna
  uppfyller säkerhetskrav motsvarande Freja eID+._

### Ny paragraf § 5.9 - Tekniskt haveri

_Vid tekniskt haveri med det digitala röstningssystemet har mötesordföranden
följande befogenheter:_

1. **_Kortvarigt avbrott (< 30 minuter):_** _Mötesordföranden kan förlänga
   röstningstiden motsvarande avbrottstiden._

2. **_Längre avbrott (> 30 minuter):_** _Mötesordföranden kan pausa mötet
   tills systemet är återställt. Mötet återupptas när systemet är
   funktionellt._

3. **_Systemet kan inte återställas:_** _Om systemet inte kan återställas
   inom rimlig tid kan mötesordföranden, efter godkännande av 2/3 majoritet
   av fysiskt närvarande medlemmar, besluta om:_
   - _Ajournering av mötet till senare datum, eller_
   - _Manuell röstning för fysiskt närvarande medlemmar (endast för aktuell
     fråga)_

4. **_Dokumentation:_** _Alla beslut enligt denna paragraf ska dokumenteras i
   protokollet med motivering och tidsstämplar._

### Ny paragraf § 5.10 - Anonymitet och revision

_Det digitala röstningssystemet ska garantera anonymitet enligt följande
principer:_

1. **_Dataseparation:_** _Information om vem som röstat och vad de röstat på
   ska lagras i separata databastabeller utan koppling._

2. **_Revisionsspår:_** _Systemet ska logga följande information oföränderligt:_
   - _Vilka medlemmar som loggat in och när_
   - _Administrativa ändringar (vem, vad, när)_
   - _Antal röster per fråga (men inte innehåll per individ)_
   - _Tekniska händelser (systemfel, omstarter, etc.)_

3. **_Revisorns tillgång:_** _Revisor och ombudsman har rätt att granska
   loggar enligt punkt 2, men får INTE tillgång till information som kopplar
   specifika medlemmar till specifika röster._

4. **_Verifierbarhet:_** _Varje medlem ska kunna verifiera att den egna rösten
   räknats korrekt via en personlig kvittokod, utan att avslöja för andra vad
   medlemmen röstade på._

5. **_Radering:_** _Efter att årsmötets protokoll godkänts ska all data som
   möjliggör koppling mellan identitet och röst raderas permanent.
   Revisionsspår enligt punkt 2 ska bevaras._
...
- **Stark Autentisering:** Inloggning ska ske via Freja eID+ som verifierar
  ...
  röstning tillåts. Detta gör det i praktiken omöjligt/orimligt att dela
